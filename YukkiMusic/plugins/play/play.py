...
from strings.helpers import BLACKLIST_WORDS
...
async def play_commnd(
    ...
    # FUCKING UR MUM
    query_list = message.text.lower().split(" ")
    for bl_word in BLACKLIST_WORDS:
        if bl_word in query_list:
            await message.reply_text("Go to pornhub.com for it!")
            return
